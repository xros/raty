...
Raty.prototype._attributesForIndex = function(i) {
  ...
  var attributes = { 'data-alt': i, 'class': this.opt[name] };
...
Raty.prototype._getHint = function(score, evt) {
  ...
  var
    decimal = this._getFirstDecimal(score),
...
Raty.prototype._getFirstDecimal = function(number) {
  var
...
Raty.prototype.score = function(number) {
...
(function($) {
  ...
  $.fn.raty = function(options) {
    ...
    return this.each(function() {
      var
        self     = $(this),
        instance = self.data('raty') || new Raty(this, options);
