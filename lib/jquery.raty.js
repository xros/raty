...
// done
Raty.prototype._adjustedScore = function(score) {
  'use strict';
...
// done
Raty.prototype._adjustHints = function() {
  'use strict';
...
// done
Raty.prototype._adjustPrecision = function() {
  this.opt.half = true;
};

// done
Raty.prototype._adjustStarName = function() {
...
// done
Raty.prototype._attributesForCancel = function() {
  'use strict';

  var
    name       = 'cancelOff',
    attributes = { alt: 'x', src: this.opt.path + this.opt[name] };

  if (this.opt.starType !== 'img') {
    attributes = { 'data-alt': 'x', 'class': this.opt[name] };
  }

  // attributes.title = this._getHint(i); // TODO: where is the title?
...
Raty.prototype._create = function() {
  ...
  this.score = this._adjustedScore(this.opt.score);
...
// done
Raty.prototype._createCancel = function() {
  'use strict';

  var
    attributes = this._attributesForCancel(),
    method     = this.opt.cancelPlace === 'left' ? 'prepend' : 'append';

  this.cancel = $('<' + this.opt.starType + ' />', attributes);

  this.self[method]('&#160;')[method](this.cancel);
};
